...
import com.nvt.it_job.service.CompanyService;
...
public class CompanyController {
    ...
    public ResponseEntity<Company> fetchUserById(@PathVariable("id") long id) {
        return ResponseEntity.ok(this.companyService.handleFetchCompanyById(id));
    }
    ...
    public ResponseEntity<ResultPaginationDTO> fetchAllUser(
        ...
        return ResponseEntity.ok(this.companyService.handleFetchAllCompany(spec, pageable));
    }
